...
UP_SINGLE_MOVES = {
(i, j): list(filter(None, [UP_RIGHT_SINGLE_MOVES.get((i, j), None), UP_LEFT_SINGLE_MOVES.get((i, j), None)]))
for i in range(BOARD_ROWS)
for j in range(BOARD_COLS)
if IS_BLACK_TILE((i, j))}
DOWN_SINGLE_MOVES = {
(i, j): list(filter(None, [DOWN_RIGHT_SINGLE_MOVES.get((i, j), None), DOWN_LEFT_SINGLE_MOVES.get((i, j), None)]))
for i in range(BOARD_ROWS)
for j in range(BOARD_COLS)
if IS_BLACK_TILE((i, j))}
...
UP_CAPTURE_MOVES = {
(i, j): list(filter(None, [UP_RIGHT_CAPTURE_MOVES.get((i, j), None), UP_LEFT_CAPTURE_MOVES.get((i, j), None)]))
for i in range(BOARD_ROWS)
for j in range(BOARD_COLS)
if IS_BLACK_TILE((i, j))}
DOWN_CAPTURE_MOVES = {
(i, j): list(filter(None, [DOWN_RIGHT_CAPTURE_MOVES.get((i, j), None), DOWN_LEFT_CAPTURE_MOVES.get((i, j), None)]))
for i in range(BOARD_ROWS)
for j in range(BOARD_COLS)
if IS_BLACK_TILE((i, j))}
